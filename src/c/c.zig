...
export fn sdfgen_sddf_net(c_sdf: *align(8) anyopaque, c_device: ?*align(8) anyopaque, driver: *align(8) anyopaque, virt_tx: *align(8) anyopaque, virt_rx: *align(8) anyopaque, c_vswitch: ?*align(8) anyopaque, c_vswitch_orchestrator: ?*align(8) anyopaque, c_rx_dma_mr: ?*align(8) anyopaque) ?*anyopaque {
    const sdf: *SystemDescription = @ptrCast(c_sdf);
