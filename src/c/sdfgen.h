...
bool sdfgen_gensvc(void *sdf, char *output_dir);
...
void *sdfgen_sddf_gpio(void *sdf, void *device, void *driver);
void sdfgen_sddf_gpio_destroy(void *system);
sdfgen_sddf_status_t sdfgen_sddf_gpio_add_client(void *system, void *client, uint8_t *driver_channel_ids, uint8_t num_driver_channel_ids);
bool sdfgen_sddf_gpio_connect(void *system);
bool sdfgen_sddf_gpio_serialise_config(void *system, char *output_dir);
...
void *sdfgen_sddf_net(void *sdf, void *device, void *driver, void *virt_tx, void *virt_rx, void *vswitch, void *vswitch_orchestrator, void *rx_dma_mr);
void sdfgen_sddf_net_destroy(void *system);
sdfgen_sddf_status_t sdfgen_sddf_net_add_client_with_copier(void *system, void *client, void *copier, uint8_t mac_addr[6], bool rx, bool tx, bool vswitch, bool optional);
